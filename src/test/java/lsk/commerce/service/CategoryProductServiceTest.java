...
class CategoryProductServiceTest {
    ...
    Album album1;
    Album album2;
    String productNumber = "djg8b246ibd8";
    ...
    class Disconnect {
        ...
        class SuccessCase {
            ...
            void basic() {
                ...
                //when
                categoryProductService.disconnect("가요", productNumber);
            ...
            void idempotency() {
                ...
                //when & then 두 번째 호출
                thenNoException().isThrownBy(() -> categoryProductService.disconnect("가요", productNumber));
    ...
    class DisconnectAll {
        ...
        class SuccessCase {
            ...
            void shouldIgnoreDisconnectAll_WhenCategoryProductsIsEmpty() {
                ...
                //when & then
                categoryProductService.disconnectAll("OST");
            ...
            void idempotency() {
                ...
                //when 두 번째 호출
                thenNoException().isThrownBy(() -> categoryProductService.disconnectAll("가요"));
    ...
    class Connect {
        ...
        class SuccessCase {
            ...
            void idempotency() {
                ...
                //when & then 두 번째 호출
                thenNoException().isThrownBy(() -> categoryProductService.connect(productNumber, "발라드"));
