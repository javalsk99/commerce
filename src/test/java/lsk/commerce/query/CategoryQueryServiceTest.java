...
@Import({
        CategoryQueryRepository.class,
        CategoryProductQueryRepository.class,
    ...
    class Find {
        ...
        class SuccessCase {
            ...
            void basic() {
                ...
                //then
                thenSoftly(softly -> {
                    softly.then(categoryQueryDto.categoryName()).isEqualTo("가요");
                    softly.then(categoryQueryDto.categoryProductQueryDtoList())
